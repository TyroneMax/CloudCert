    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-muted/30 px-4">
        <div className="w-full max-w-md text-center">
          ...
          <p className="mt-3 text-muted-foreground">{t("checkEmailDesc")}</p>
          <Link
      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-border/60 bg-card p-8 shadow-sm">
          ...
          <form onSubmit={handleEmailSignUp} className="space-y-4">
            <div>
              <label htmlFor="displayName" className="mb-1.5 block text-sm font-medium">{t("displayName")}</label>
              <input
                id="displayName"
                type="text"
                value={displayName}
            ...
            <div>
              <label htmlFor="confirmPassword" className="mb-1.5 block text-sm font-medium">{t("confirmPassword")}</label>
              <input
                id="confirmPassword"
                type="password"
